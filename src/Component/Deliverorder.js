...
function Deliverorder({ DelieveredOrders }) {
    return (
        <>
            {/* Main */}
                    ...
                    <div className="col-xl-12 col-sm-12 col-12">
                        <div className="card shadow border-0">
                            <div className="card-header">
                                <h5 className="mb-0 text-center font-weight-bold text-danger">Delievered Orders Details Page</h5>
                            </div>
                                            ...
                                            DelieveredOrders.map((items, i) => {
                                                return (
                                                    <tr>
                                                        ...
                                                        <th>{items.DeliveryDate.split(',')[0]}</th>
                                                        {/* <th>{items..split(',')[0]}</th> */}
